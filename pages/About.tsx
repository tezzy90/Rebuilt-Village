    ...
    <>
      ...
      <Section>
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          <img 
            src="https://picsum.photos/seed/director/800/600" 
        ...
        <h2 className="text-3xl font-bold mb-12 text-center">Leadership & Board</h2>
        <div className="grid md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
             <Card 
              ...
              image={`https://picsum.photos/seed/person${i}/400/300`}
            >
              <p className="text-sm">
                {i === 1 
