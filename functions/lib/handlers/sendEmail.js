...
const ContactSchema = zod_1.z.object({
    ...
    formType: zod_1.z.literal('contact').optional(),
    // Honeypot: bots fill this, humans don't
    website: zod_1.z.string().max(0).optional(),
});
const NewsletterSchema = zod_1.z.object({
    email: zod_1.z.string().email(),
    formType: zod_1.z.literal('newsletter'),
    website: zod_1.z.string().max(0).optional(),
});
const BodySchema = zod_1.z.union([ContactSchema, NewsletterSchema]);
exports.sendEmail = functions.onRequest({
    cors: [
